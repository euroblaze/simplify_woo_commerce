...
#         #inherit the post field and add selection with ID for wooCommerce
...
#             }
#
# #4. Products export (Export new products created or edited in Odoo to WooCommerce)
...
#     def update_deleted products_from_woo():
